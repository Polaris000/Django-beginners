...
# selenium library.. v3.5
# time library which should be there by default
# download chromedriver_linux64.zip from https://chromedriver.storage.googleapis.com/index.html?path=2.33/
# get anything above v2.30.. i have v2.33
# and yes, please be patient while the hints load, especially for question 2 and 4..
# please enter your chromedriver file location, email and password in the quotes marked with *****
